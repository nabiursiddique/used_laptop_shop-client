  ...
  return (
    <div className="navbar bg-base-100">
      <div className="navbar-start">
        ...
        <a className="btn btn-ghost normal-case lg:text-2xl md:text-xl sm:text-xs bg-gradient-to-r from-sky-700  to-sky-400 text-transparent bg-clip-text">AAA Technology</a>
      </div>
      ...
      <div className='navbar-end'>
        ...
        <label title='Open Drawer' htmlFor="my-drawer-2" className="drawer-button lg:hidden mr-2  bg-gradient-to-r from-sky-700  to-sky-400 text-white rounded-full p-2"><FaGreaterThan/></label>
